...
Esta plantilla puede ser usada en *Windows*, *Linux* y *Overleaf*. El diseño incluye el logo de la Universidad Rey Juan Carlos (URJC), pero también es extendible a otras universidades, simplemente cambiando este. Asimismo, la estructura de capítulos está enfocada a carreras técnicas, pero puede servir de mucha ayuda para el trabajo de cualquier otra rama.
...
Gracias a los retoques introducidos por la Profesora Eva María Cirugeda Roldán, esta plantilla es compatible con Overleaf desde el curso 2024-2025. Sus líneas están comentadas como EMCR.
